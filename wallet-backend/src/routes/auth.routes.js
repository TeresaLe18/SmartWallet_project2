...
router.post('/create-pin/send-otp', authMiddleware, authController.requestCreatePinOtp);
router.post('/create-pin/confirm', authMiddleware, authController.createPinWithOtp);
